...
public class ResultDialog extends JDialog {
    ...
    private final class WebResultWorker extends SwingWorker<Void, QueryResult> {
        ...
        public WebResultWorker(DefaultListModel resultListModel) {
        ...
        @Override
        protected void done() {
            String msg = "finished looking for new episodes";
    ...
    public void startSearch() {
        ...
        buildStatusBar().setText("Start looking for newer episodes");
        swingWorker = new WebResultWorker(resultListModel);
        swingWorker.execute();
    }
}
